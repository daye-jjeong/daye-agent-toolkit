...
| `health-tracker` | db.py 직접 import | `health_exercises`, `health_symptoms`, `health_pt_homework`, `health_check_ins`, `health_meals` |
...
| **헬스** | `health_exercises`, `health_symptoms`, `health_meals` | 운동·증상·식사 |
