...
app_path="${dist_dir}/m-agent.app"
contents_path="${app_path}/Contents"
macos_path="${contents_path}/MacOS"
resources_path="${contents_path}/Resources"
executable_name="MAgentApp"
resource_bundle_name="MAgent_MAgentRuntime.bundle"

expected_app_path="${package_dir}/dist/m-agent.app"
...
if [[ "${bundle_identifier}" != "com.dayejeong.m-agent" ]]; then
...
sign_identity="m-agent Local Signing"
