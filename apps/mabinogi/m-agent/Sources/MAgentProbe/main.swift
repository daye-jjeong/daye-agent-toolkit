...
Usage:
  MAgentProbe version
  MAgentProbe list
  MAgentProbe visibility --bundle-id <id> --title <text>
  MAgentProbe capture --bundle-id <id> --title <text> --output <path>
  MAgentProbe click --bundle-id <id> --title <text> --x <0...1> --y <0...1>
  MAgentProbe foreground-click --bundle-id <id> --title <text> --x <0...1> --y <0...1>
"""
...
do {
    ...
    case let .click(
        ...
        let beforePath = "/tmp/m-agent-click-before.png"
        let afterPath = "/tmp/m-agent-click-after.png"
    ...
    case let .foregroundClick(
        ...
        let beforePath =
            "/tmp/m-agent-foreground-before.png"
        let afterPath =
            "/tmp/m-agent-foreground-after.png"
