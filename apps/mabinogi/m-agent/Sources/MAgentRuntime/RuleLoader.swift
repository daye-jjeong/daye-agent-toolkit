...
public enum MAgentPaths {
    ...
    public static func supportDirectory(
        ...
        mabiHome(fileManager: fileManager)
            .appendingPathComponent("m-agent", isDirectory: true)
    }
...
public struct RuleLoader: Sendable {
    ...
    public func loadDefaultRules(
        ...
        let overrideURL = MAgentPaths.overrideRulesURL()
