...
> `vault/+inbox/` 미분류 항목을 스캔하고 적절한 위치로 분류한다.
...
| meeting, 회의, 미팅 | `vault/reports/` |
| policy, 정책, 규칙 | `vault/policy/` |
| research, 리서치, 분석 | `vault/reports/` |
...
| # | 파일 | → 이동 대상 | 이유 |
|---|------|-----------|------|
| 1 | meeting-notes.md | vault/reports/ | 미팅 키워드 |
